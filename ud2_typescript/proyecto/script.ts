...
function update(){
    ...
    let golesLocal: HTMLInputElement = document.getElementById("gol_local")as HTMLInputElement;
    let golesVisitante: HTMLInputElement = document.getElementById("gol_visitante")as HTMLInputElement;
